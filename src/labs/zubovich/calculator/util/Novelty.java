...
public enum Novelty {
    ABSOLUTLY_NEW("Принципиально новые ПО, не имеющие подобных аналогов", 1.58, 1.44, 1.10, 1.0),
    LOW_NEW("ПО, являющиеся развитием определенного параметрического ряда ПО)", 1.0, 0.81, 0.72, 0.63);
